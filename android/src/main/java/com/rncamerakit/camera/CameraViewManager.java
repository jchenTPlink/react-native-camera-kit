...
public class CameraViewManager extends SimpleViewManager<CameraView> {
    ...
    private static void updateCameraSize() {
        try {
            ...
            // Get the optimal preview size that matches the screen dimensions
            Camera.Size optimalSize = getOptimalPreviewSize(supportedSizes, actualPreviewWidth, actualPreviewHeight);
